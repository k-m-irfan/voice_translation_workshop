...
#=======================================ENDPONTS==========================================
"""Update the below area with their respective endpoints"""
# asr_endpoint = # add ASR endpoint here
# mt_endpoint = # add MT endpoint here
# tts_endpoint = # add TTS endpoint here

# USE AND SHARE PROXY ENDPOINTS WITH PARTICIPANTS
asr_endpoint = "http://projects.respark.iitm.ac.in:8009/asr"
mt_endpoint = "http://projects.respark.iitm.ac.in:8009/translate"
tts_endpoint = "http://projects.respark.iitm.ac.in:8009/tts"
...
#//////////////////////////////////////////////////////////////////////////////////////////
    ...
    """
    stt = json.loads(speech_to_text(input_language, audio_data))['transcript']
    ...
    """
    translation = mt(input_language, target_language, stt)
    ...
    tts = text_to_speech(translation, "female", target_language)['audio']
...
def speech_to_text(input_language,input_file):
    ...
    headers = {}
    response = requests.request("POST", asr_endpoint, headers=headers, data=payload, files=files)
...
def mt(src_language,tgt_language,transcript):
    ...
    payload = {'src_language':src_language,'tgt_language':tgt_language,'transcript': transcript}
    response = requests.post(mt_endpoint,data = payload).json()
...
def text_to_speech(text,gender,lang):
    ...
    print("\nText to Speech function called")
    payload = json.dumps({
		"input": text,
		"gender": gender,
		"lang": lang,
    ...
    response = requests.request("POST", tts_endpoint, headers=headers, data=payload).json()
